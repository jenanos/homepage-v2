...
const testimonials: Array<{
  ...
  {
    quote:
      "Guest on Anine Kierulf's podcast discussing artificial intelligence (AI) and large language models (LLMs)",
    name: "Takk og Lov",
    src: "/takkoglov.jpg",
  ...
  {
    quote:
      "Guest on Bouvet's podcast exploring the EU AI Regulation, alongside Eva Jarbekk, moderated by Simen Sommerfeldt.",
    name: "Bouvet Bobler",
    src: "/bobler.jpg",
  ...
  {
    quote:
      "Panel discussion on Schrems II, featuring Line Coll and Dag Schartum, moderated by Silje Nordnes.",
    name: "Nokios",
    src: "/nokios.jpg",
  ...
  {
    quote:
      "Keynote speaker on the main stage at GoForIT's conference, focusing on generative AI in the public sector.",
  ...
  {
    quote:
      "Guest on the Research Council of Norway's podcast, discussing AI with Inga Strümke, moderated by Olaug Råd.",
...
export default function Speaking() {
  return (
    <section
      id="speaking"
      className="min-h-screen md:min-h-fit w-screen pt-24 flex flex-col items-center justify-center bg-gradient-to-b from-[#001122] to-[#1E3A8A]"
      aria-labelledby="speaking-heading"
    >
      <h2 id="speaking-heading" className="p-4 text-4xl text-white">
        Public speaking
      </h2>
