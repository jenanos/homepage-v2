...
export const AnimatedTestimonials = ({
  ...
  return (
    <div className="max-w-sm md:max-w-4xl mx-auto antialiased font-sans px-4 md:px-8 lg:px-12 pt-4 md:py-20">
      <div {...handlers} className="relative overflow-hidden">
        <div className="relative grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
          ...
          <div className="flex justify-between flex-col pb-2 md:py-4 items-center text-center">
            <motion.div
              key={active}
              initial={{
                y: 20,
